# 1st round: In Memory Attack!

## Powershell Obfuscation 

For this round of CTF, we were given a .jsp file : **mail.jsp**. From the clue given, this .jsp file contains obfuscated powershell codes. Notice the I'EX command at the beginning of the code
...
Run the powershell in administrator mode and put the code from the mail.jsp file. Then, run the code.

<img width="578" alt="Capture3" src="https://user-images.githubusercontent.com/81545840/121386897-d3b64e80-c97c-11eb-9914-f52254a02f27.PNG">

### #2

We will use Event Viewer to analyze the running codes in the powershell. Go to _Application and Services Logs > Microsoft > Windows > Powershell > Operational_. Here we can see a list of running logs from the powershell. Click on the latest log and there will be a readable code. We can solve the 1st round by checking on these codes.

<img width="577" alt="Capture2" src="https://user-images.githubusercontent.com/81545840/121384939-445c6b80-c97b-11eb-9289-418f34962c62.PNG">

```
Log Name:      Microsoft-Windows-PowerShell/Operational
Source:        Microsoft-Windows-PowerShell
Date:          5/31/2021 9:37:47 AM
Event ID:      4104
Task Category: Execute a Remote Command
Level:         Warning
Keywords:      None
User:          DESKTOP-TQJPBPH\ainaz
Computer:      DESKTOP-TQJPBPH
Description:
